...
OUTPUT_CSV = BASE_DIR / "raw_outputs/llama3_1_8b_jokes.csv"
...
def main():
    ...
    try:
        ...
        print("Please check your HF_TOKEN and ensure you have access to Llama 3.1.")
        return
    ...
    for combo in tqdm(target_combos, desc="Generating (Llama 8B Full)"):
        ...
        while jokes_needed > 0:
            ...
            for joke in parsed_jokes:
                writer.writerow([combo, user_prompt, joke, "Llama-3.1-8B-Full"])
            f_out.flush()
